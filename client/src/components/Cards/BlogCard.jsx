...
/**
 * BlogCard - Style: Artistic frame with image
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[400px] w-full overflow-hidden transition-transform duration-500 hover:-translate-y-2">
        ...
        <div className="absolute inset-0 border-[6px] border-white/40 z-20 pointer-events-none rounded-xs"></div>
        ...
        <div className="absolute top-4 right-4 z-30 bg-bg-main text-text-primary px-3 py-2 text-center shadow-md rotate-3 group-hover:rotate-0 transition-transform duration-300">
